...
|---|---|---|---|
| **Ana Sayfa** (kişisel imza) | `depth-dust.js` | Derinlik Tozu — dört derinlik katmanında süzülen toz parçacıkları, mouse'a gecikmeli (eased) paralaks, ön katmanda ara sıra 4 uçlu pırıltı. (compass-bearing.js, skyline-growth.js ve brick-layers.js denendi ve emekli edildi; dosyaları yedekte duruyor) | `176, 141, 79` (brass) |
